...
class TwoInputsCenterOutputRecipe(
    ...
    override fun addWidgets(widgets: WidgetHolder) {
        ...
        widgets.add(ProgressBarWidget(38, 29, recipe.time * 50.0, GuiBuilder.ProgressDirection.RIGHT))
        widgets.add(ProgressBarWidget(74, 29, recipe.time * 50.0, GuiBuilder.ProgressDirection.LEFT))
