package me.zaksen.emitechreborn.client.emi.atr.machine

import dev.emi.emi.api.recipe.EmiRecipeCategory
import dev.emi.emi.api.widget.TextWidget
import dev.emi.emi.api.widget.WidgetHolder
import me.zaksen.emitechreborn.client.emi.tr.machine.AbstractMachineRecipe
...
class CanningMachineRecipe(
    ...
    override fun addWidgets(widgets: WidgetHolder) {
        ...
        widgets.add(ProgressBarWidget(52, 31, recipe.value.time() * 50.0, GuiBuilder.ProgressDirection.RIGHT))
